...
const mahasiswa = [
  ...
  for (let gandidi = 0; gandidi < mahasiswa.length; gandidi++) {
    if (mahasiswa[gandidi].postgraduate) {
        postGraduate.push (
            {
                name: mahasiswa[gandidi].name,
                mastery: mahasiswa[gandidi].mastery,
            }
        )       
    }
  ...
  for (let gandidi = 0; gandidi < postGraduate.length; gandidi++){
    console.log("Nama : " + postGraduate[gandidi].name + "\nKeahlian : " + postGraduate[gandidi].mastery);
  }

  console.log("Mahasiswa S1")
  for (let gandidi = 0; gandidi < bachelorDegree.length; gandidi++){
    console.log("Nama : " + bachelorDegree[gandidi].name + "\nIPK : " + bachelorDegree[gandidi].GPA);
  }
